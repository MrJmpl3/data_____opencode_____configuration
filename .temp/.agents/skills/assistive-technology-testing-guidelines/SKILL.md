---
name: assistive-technology-testing-guidelines
description: Test user interfaces with assistive technologies including VoiceOver, NVDA, JAWS, TalkBack, and Narrator. Use when validating keyboard access, announcements, focus behavior, or overall accessibility support.
---

# Assistive Technology Testing

Practical guide to testing interfaces with assistive technologies for comprehensive accessibility validation.
