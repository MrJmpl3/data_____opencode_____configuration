...
import { debugLog, setDebugEnabled } from '../../../src/features/subagent-status/shared/display.ts';
...
describe('debug flag', () => {
  ...
  it('starts disabled by default', async () => {
    vi.resetModules();
    const { debugLog: freshDebugLog } = await import('../../../src/features/subagent-status/shared/display.ts');
