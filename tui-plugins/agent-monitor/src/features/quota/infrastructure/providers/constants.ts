...
// Browser impersonation UA required because OpenAI and OpenRouter
// return different response shapes to non-browser User-Agents.
// WARNING: impersonating a browser may violate provider ToS.
// TODO(compliance-review): track in legal review — greppable placeholder.
