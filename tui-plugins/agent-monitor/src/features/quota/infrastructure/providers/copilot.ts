import type { CopilotResult, QuotaDisplayMode, QuotaLine } from '../../domain/types.ts';
import { MONTH_SECONDS } from '../../domain/types.ts';
import { formatCountQuota } from '../../domain/lines.ts';
...
import { findBoolean, findNumber, findString } from '../../../../kit/coercion.ts';
