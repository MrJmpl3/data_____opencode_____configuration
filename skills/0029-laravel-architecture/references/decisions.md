...
**See [Actions](../../0025-laravel-actions/SKILL.md) for complete implementation guide**
...
**See [DTOs](../../0052-laravel-dtos/SKILL.md) for complete implementation guide**
...
**See [Models](../../0073-laravel-models/SKILL.md) for custom builder implementation**
...
**See [Controllers](../../0045-laravel-controllers/SKILL.md) for controller patterns**
...
**See [Actions](../../0025-laravel-actions/SKILL.md) for action patterns**
...
**See [form-requests.md](../../0111-laravel-validation/references/form-requests.md) for validation
patterns**
...
**See [structure.md](structure.md) and [Controllers](../../0045-laravel-controllers/SKILL.md) for
routing details**
