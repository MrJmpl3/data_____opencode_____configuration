...
- [Actions](../../0025-laravel-actions/SKILL.md) - Action pattern and organization
- [DTOs](../../0052-laravel-dtos/SKILL.md) - DTO structure and transformers
- [Controllers](../../0045-laravel-controllers/SKILL.md) - HTTP layer organization
- [Models](../../0073-laravel-models/SKILL.md) - Model structure and custom builders
- [Multi-tenancy](../../0074-laravel-multi-tenancy/SKILL.md) - Multi-tenant directory organization
- [validation-testing.md](../../0111-laravel-validation/references/validation-testing.md) - Test
