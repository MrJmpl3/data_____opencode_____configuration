...
- [testing-factories.md](references/testing-factories.md) - Declarative factory methods for readable
  tests
- [validation-testing.md](../0113-laravel-validation/references/validation-testing.md) - Form
  request validation testing
- [Actions](../0027-laravel-actions/SKILL.md) - Action pattern for unit testing
- [Controllers](../0047-laravel-controllers/SKILL.md) - Controller patterns for feature testing
- [DTOs](../0054-laravel-dtos/SKILL.md) - DTO test factories
- [Services](../0098-laravel-services/SKILL.md) - Service layer with null drivers
...
See [Services](../0098-laravel-services/SKILL.md) for complete implementation examples.
...
See [DTOs](../0054-laravel-dtos/SKILL.md) for test factory setup and implementation.
