...
- [testing-factories.md](references/testing-factories.md) - Declarative factory methods for readable
  tests
- [validation-testing.md](../0111-laravel-validation/references/validation-testing.md) - Form
  request validation testing
- [Actions](../0025-laravel-actions/SKILL.md) - Action pattern for unit testing
- [Controllers](../0045-laravel-controllers/SKILL.md) - Controller patterns for feature testing
- [DTOs](../0052-laravel-dtos/SKILL.md) - DTO test factories
- [Services](../0096-laravel-services/SKILL.md) - Service layer with null drivers
...
See [Services](../0096-laravel-services/SKILL.md) for complete implementation examples.
...
See [DTOs](../0052-laravel-dtos/SKILL.md) for test factory setup and implementation.
