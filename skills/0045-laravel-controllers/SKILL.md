...
- [Actions](../0025-laravel-actions/SKILL.md) - Actions contain the domain logic
- [form-requests.md](../0111-laravel-validation/references/form-requests.md) - Validation layer
- [DTOs](../0052-laravel-dtos/SKILL.md) - DTOs for data transfer
- [structure.md](../0029-laravel-architecture/references/structure.md) - Web vs API organization
