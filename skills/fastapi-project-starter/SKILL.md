...
description: Create production-ready FastAPI project starters with async patterns, dependency injection, and comprehensive error handling. Use when scaffolding new FastAPI services or setting up backend API projects.
---

# FastAPI Project Starter

Production-ready FastAPI project starters with async patterns, dependency injection, middleware, and best practices for building high-performance APIs.
