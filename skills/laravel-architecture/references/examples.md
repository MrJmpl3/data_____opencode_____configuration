...
- [Testing](../../laravel-testing/SKILL.md) - Testing guide with triple-A pattern, mocking, and
  factories
- [validation-testing.md](../../laravel-validation/references/validation-testing.md) - Comprehensive
  validation testing
