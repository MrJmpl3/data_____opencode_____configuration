...
- [Query Builders](../0089-laravel-query-builders/SKILL.md) - Custom query builders (not scopes)
- [Actions](../0025-laravel-actions/SKILL.md) - Actions contain business logic
- [DTOs](../0052-laravel-dtos/SKILL.md) - Casting model JSON columns to DTOs
...
- Use **custom query builders** (not local scopes) - see
  [Query Builders](../0089-laravel-query-builders/SKILL.md)
