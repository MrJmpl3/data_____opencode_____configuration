...
- [Models](../0056-laravel-models/SKILL.md) - Model integration with custom builders
- [Controllers](../0028-laravel-controllers/SKILL.md) - Using query objects in controllers
