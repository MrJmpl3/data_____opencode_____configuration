...
- [State Machines](../0101-laravel-state-machines/SKILL.md) - For complex state transitions
- [Models](../0075-laravel-models/SKILL.md) - Model casts to enums
- [DTOs](../0054-laravel-dtos/SKILL.md) - DTOs with enum properties
- [form-requests.md](../0113-laravel-validation/references/form-requests.md) - Enum validation
...
See [State Machines](../0101-laravel-state-machines/SKILL.md) for state machines.
