...
- [Controllers](../../0028-laravel-controllers/SKILL.md) - Controllers use form requests
- [DTOs](../../0035-laravel-dtos/SKILL.md) - Transformers convert validated requests to DTOs
- [validation-testing.md](validation-testing.md) - Testing form request validation
- [testing-conventions.md](../../0090-laravel-testing/references/testing-conventions.md) - Test file structure
...
- [Quality](../../0069-laravel-quality/SKILL.md) - Testing standards and practices
