...
- **[nuxt-features](../../0131-nuxt-features/SKILL.md)** - Queries/actions (prefer over
  data-fetching composables)
- **[nuxt-realtime](../../0136-nuxt-realtime/SKILL.md)** - Real-time subscriptions
- **[nuxt-components](../../0126-nuxt-components/SKILL.md)** - Using composables in components
