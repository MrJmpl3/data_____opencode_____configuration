...
- [Controllers](../../0028-laravel-controllers/SKILL.md) - Controller structure and RESTful method ordering
...
- [Controllers](../../0028-laravel-controllers/SKILL.md) - RESTful method ordering and conventions
- [validation-testing.md](../../0094-laravel-validation/references/validation-testing.md) - Dataset-based validation testing
- [routing-permissions.md](../../0077-laravel-routing/references/routing-permissions.md) - Route-level authorization configuration
