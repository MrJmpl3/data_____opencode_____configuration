...
- [validation-testing.md](../0094-laravel-validation/references/validation-testing.md) - Form request validation testing
- [Actions](../0008-laravel-actions/SKILL.md) - Action pattern for unit testing
- [Controllers](../0028-laravel-controllers/SKILL.md) - Controller patterns for feature testing
- [DTOs](../0035-laravel-dtos/SKILL.md) - DTO test factories
- [Services](../0079-laravel-services/SKILL.md) - Service layer with null drivers
...
See [Services](../0079-laravel-services/SKILL.md) for complete implementation examples.
...
See [DTOs](../0035-laravel-dtos/SKILL.md) for test factory setup and implementation.
