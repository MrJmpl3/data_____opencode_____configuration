...
- [route-binding.md](../../0077-laravel-routing/references/route-binding.md) - Route model binding configuration
- [package-extraction.md](../../0060-laravel-packages/references/package-extraction.md) - Creating service providers for packages
...
**See [DTOs](../../0035-laravel-dtos/SKILL.md) for complete factory examples.**

See [route-binding.md](../../0077-laravel-routing/references/route-binding.md) for route model binding configuration including the ConditionalRouteBinder pattern.
