...
This bundled skill helps the `oracle` agent review and simplify code without changing behavior. It
...
Bundled with `oh-my-opencode-slim` and installed automatically when bundled skills are enabled via
the installer.
