...
- [Actions](../0008-laravel-actions/SKILL.md) - Actions contain the domain logic
- [form-requests.md](../0094-laravel-validation/references/form-requests.md) - Validation layer
- [DTOs](../0035-laravel-dtos/SKILL.md) - DTOs for data transfer
- [structure.md](../0012-laravel-architecture/references/structure.md) - Web vs API organization
