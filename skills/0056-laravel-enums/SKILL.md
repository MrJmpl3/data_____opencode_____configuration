...
- [State Machines](../0099-laravel-state-machines/SKILL.md) - For complex state transitions
- [Models](../0073-laravel-models/SKILL.md) - Model casts to enums
- [DTOs](../0052-laravel-dtos/SKILL.md) - DTOs with enum properties
- [form-requests.md](../0111-laravel-validation/references/form-requests.md) - Enum validation
...
See [State Machines](../0099-laravel-state-machines/SKILL.md) for state machines.
