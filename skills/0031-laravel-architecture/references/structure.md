...
- [Actions](../../0027-laravel-actions/SKILL.md) - Action pattern and organization
- [DTOs](../../0054-laravel-dtos/SKILL.md) - DTO structure and transformers
- [Controllers](../../0047-laravel-controllers/SKILL.md) - HTTP layer organization
- [Models](../../0075-laravel-models/SKILL.md) - Model structure and custom builders
- [Multi-tenancy](../../0076-laravel-multi-tenancy/SKILL.md) - Multi-tenant directory organization
- [validation-testing.md](../../0113-laravel-validation/references/validation-testing.md) - Test
