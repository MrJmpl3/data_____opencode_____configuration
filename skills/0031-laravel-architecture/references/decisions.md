...
**See [Actions](../../0027-laravel-actions/SKILL.md) for complete implementation guide**
...
**See [DTOs](../../0054-laravel-dtos/SKILL.md) for complete implementation guide**
...
**See [Models](../../0075-laravel-models/SKILL.md) for custom builder implementation**
...
**See [Controllers](../../0047-laravel-controllers/SKILL.md) for controller patterns**
...
**See [Actions](../../0027-laravel-actions/SKILL.md) for action patterns**
...
**See [form-requests.md](../../0113-laravel-validation/references/form-requests.md) for validation
patterns**
...
**See [structure.md](structure.md) and [Controllers](../../0047-laravel-controllers/SKILL.md) for
routing details**
