...
- [Query Builders](../0091-laravel-query-builders/SKILL.md) - Custom query builders (not scopes)
- [Actions](../0027-laravel-actions/SKILL.md) - Actions contain business logic
- [DTOs](../0054-laravel-dtos/SKILL.md) - Casting model JSON columns to DTOs
...
- Use **custom query builders** (not local scopes) - see
  [Query Builders](../0091-laravel-query-builders/SKILL.md)
