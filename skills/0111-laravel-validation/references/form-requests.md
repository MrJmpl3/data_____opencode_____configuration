...
- [Controllers](../../0045-laravel-controllers/SKILL.md) - Controllers use form requests
- [DTOs](../../0052-laravel-dtos/SKILL.md) - Transformers convert validated requests to DTOs
- [validation-testing.md](validation-testing.md) - Testing form request validation
- [testing-conventions.md](../../0107-laravel-testing/references/testing-conventions.md) - Test file
  structure
...
- [Quality](../../0086-laravel-quality/SKILL.md) - Testing standards and practices
