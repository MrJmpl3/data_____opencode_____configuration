...
- [DTOs](../../mrjmpl3-laravel-dtos/SKILL.md) - Typed DTOs with property promotion
- [Actions](../../mrjmpl3-laravel-actions/SKILL.md) - Typed action parameters and returns
- [Models](../../mrjmpl3-laravel-models/SKILL.md) - Model casts and property types
...
See [quality.md](../SKILL.md) for complete architecture test examples.
