...
- [Actions](../0027-laravel-actions/SKILL.md) - Actions contain the domain logic
- [form-requests.md](../0113-laravel-validation/references/form-requests.md) - Validation layer
- [DTOs](../0054-laravel-dtos/SKILL.md) - DTOs for data transfer
- [structure.md](../0031-laravel-architecture/references/structure.md) - Web vs API organization
