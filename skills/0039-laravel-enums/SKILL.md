...
- [State Machines](../0082-laravel-state-machines/SKILL.md) - For complex state transitions
- [Models](../0056-laravel-models/SKILL.md) - Model casts to enums
- [DTOs](../0035-laravel-dtos/SKILL.md) - DTOs with enum properties
- [form-requests.md](../0094-laravel-validation/references/form-requests.md) - Enum validation
...
See [State Machines](../0082-laravel-state-machines/SKILL.md) for state machines.
