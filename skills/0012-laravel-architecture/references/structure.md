...
- [Actions](../../0008-laravel-actions/SKILL.md) - Action pattern and organization
- [DTOs](../../0035-laravel-dtos/SKILL.md) - DTO structure and transformers
- [Controllers](../../0028-laravel-controllers/SKILL.md) - HTTP layer organization
- [Models](../../0056-laravel-models/SKILL.md) - Model structure and custom builders
- [Multi-tenancy](../../0057-laravel-multi-tenancy/SKILL.md) - Multi-tenant directory organization
- [validation-testing.md](../../0094-laravel-validation/references/validation-testing.md) - Test datasets for validation testing
