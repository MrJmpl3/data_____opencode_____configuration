...
**See [Actions](../../0008-laravel-actions/SKILL.md) for complete implementation guide**
...
**See [DTOs](../../0035-laravel-dtos/SKILL.md) for complete implementation guide**
...
**See [Models](../../0056-laravel-models/SKILL.md) for custom builder implementation**
...
**See [Controllers](../../0028-laravel-controllers/SKILL.md) for controller patterns**
...
**See [Actions](../../0008-laravel-actions/SKILL.md) for action patterns**
...
**See [form-requests.md](../../0094-laravel-validation/references/form-requests.md) for validation patterns**
...
**See [structure.md](structure.md) and [Controllers](../../0028-laravel-controllers/SKILL.md) for routing details**
