...
- [Actions](../../0008-laravel-actions/SKILL.md) - Action patterns
- [DTOs](../../0035-laravel-dtos/SKILL.md) - DTO patterns
- [Controllers](../../0028-laravel-controllers/SKILL.md) - Controller patterns
- [form-requests.md](../../0094-laravel-validation/references/form-requests.md) - Validation patterns
- [Testing](../../0090-laravel-testing/SKILL.md) - Testing guide with triple-A pattern, mocking, and factories
- [validation-testing.md](../../0094-laravel-validation/references/validation-testing.md) - Comprehensive validation testing
- [Models](../../0056-laravel-models/SKILL.md) - Model and custom builder patterns
