...
- **[nuxt-features](../../0129-nuxt-features/SKILL.md)** - Queries/actions (prefer over
  data-fetching composables)
- **[nuxt-realtime](../../0134-nuxt-realtime/SKILL.md)** - Real-time subscriptions
- **[nuxt-components](../../0124-nuxt-components/SKILL.md)** - Using composables in components
